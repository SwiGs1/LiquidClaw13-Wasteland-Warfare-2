...
/mob/living/simple_animal/hostile/wolf/mongrel
	...
	response_harm   = "kicks"
	var/known_commands = list("stay", "stop", "attack", "follow")
	healable = 1
...
/mob/living/simple_animal/hostile/wolf/mongrel/proc/hit_with_weapon(obj/item/O, mob/living/user, var/effective_force, var/hit_zone)
	. = ..()
	if (!.)
