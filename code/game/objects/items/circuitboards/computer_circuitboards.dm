...
/obj/item/circuitboard/computer/fevbunker_control
	name = "FEV Bunker Elevator Control (Computer board)"
	build_path = /obj/machinery/computer/shuttle/fevbunkerelevator
